...
if not paths.dirp('/home/jie/keras_experiment/kmeans_new/src/cifar-10-batches-t7') then
...
for i = 0, 4 do
   local subset = torch.load('/home/jie/keras_experiment/kmeans_new/src/cifar-10-batches-t7/data_batch_' .. (i+1) .. '.t7', 'ascii')
...
local subset = torch.load('/home/jie/keras_experiment/kmeans_new/src/cifar-10-batches-t7/test_batch.t7', 'ascii')
local testData = {
...
train_csv = io.open("trainData.csv", "w")
test_csv  = io.open("testData.csv", "w")
