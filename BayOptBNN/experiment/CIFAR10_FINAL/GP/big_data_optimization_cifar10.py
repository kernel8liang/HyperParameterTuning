...
def big_data_optimization(plots=True):
    ...
    # --- Objective function
    objective_noisy = GPyOpt.fmodels.experimentCIFAR10.cifar10Experiment(input_dim = 5,bounds = [(0.001,0.1),(0.6,0.9),(0.2,0.7),(0.2,0.7), (0.2,0.7)])
    ...
    BO_demo_big_data = GPyOpt.methods.BayesianOptimization(f=objective_noisy.f,  # function to optimize       
                                            ...
                                            numdata_initial_design = 1)        # Initialize the model with 1 points
    ...
    BO_demo_big_data.save_report("gp_report_final_inputdim1000.txt")
