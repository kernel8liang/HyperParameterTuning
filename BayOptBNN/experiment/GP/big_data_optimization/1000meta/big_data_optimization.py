...
def big_data_optimization(plots=True):
    ...
    # --- Objective function
    objective_noisy = GPyOpt.fmodels.experimentsNd.alpine2(5,sd = 0.1)     # Alpine2 function in dimension 10.
    ...
    # --- Plots
    if plots:
        BO_demo_big_data.plot_convergence("gp_covergence_final_inputdim5.pdf")
    BO_demo_big_data.save_report()
