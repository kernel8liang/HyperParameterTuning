This BayOptBNN is implemented based on the library [GPyOpt](https://github.com/SheffieldML/GPyOpt) which use bayesian optimization fitted with Gaussian Process.
