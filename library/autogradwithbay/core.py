...
# These functions will get clobbered when autogradwithbay.numpy is imported.
# They're here to allow the use of autogradwithbay without numpy.
I = lambda g: g
...
common_errors = defaultdict(lambda: None, {
    (TypeError, 'float() argument must be a string or a number'):
        "This error *might* be caused by assigning into arrays, which autogradwithbay doesn't support.",
})
