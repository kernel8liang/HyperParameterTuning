...
from hypergrad.nn_utils import make_nn_funs, VectorParser, logit, nice_layer_name
...
N_valid = 10000
N_tests = 10000
N_learning_checkpoint = 5
thin = np.ceil(N_iters/N_learning_checkpoint)   # Detailed learning curves.
