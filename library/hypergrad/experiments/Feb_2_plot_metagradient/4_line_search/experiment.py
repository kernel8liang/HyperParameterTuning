...
# ----- Superparameters -----
N_gradients_in_average = 100
N_points_in_line_search = 1000
...
def run():
    ...
    stepsize_scale = 1000./np.max(np.exp(parsed_avg_grad['log_alphas'].ravel()))
...
def plot():
    ...
    with open('results.pkl') as f:
        results, parser, first_gradient, avg_gradient, stepsizes = pickle.load(f)
