...
"""
This is a demo to demonstrate how to perform parallel Bayesian optimization with BO_BNN. Run the example by writing:

import BO_BNN
BO_demo_parallel= BO_BNN.demos.parallel_optimization()
...
#     objective_noisy = BO_BNN.fmodels.experiments2d.branin(sd = 0.1)         # noisy version
